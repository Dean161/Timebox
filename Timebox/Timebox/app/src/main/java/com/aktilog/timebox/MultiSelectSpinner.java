...
public class MultiSelectSpinner extends AppCompatTextView implements DialogInterface.OnMultiChoiceClickListener {
    ...
    private MultiSelectSpinner.MultiSpinnerListener mListener;
    ...
    private OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            builder.setMultiChoiceItems(choices, mSelected, MultiSelectSpinner.this);
    ...
    public void setAdapter(SpinnerAdapter adapter, boolean allSelected, MultiSelectSpinner.MultiSpinnerListener listener) {
    ...
    public void setOnItemsSelectedListener(MultiSelectSpinner.MultiSpinnerListener listener) {
        this.mListener = listener;
    }
